    ...
    case() {
        switch (this.len) {
            ...
            case protocol.client.setPixel:
                ...
                if (server.manager.chunk_is_protected(this.client.world, tileX, tileY) && this.client.rank < 2) return;
            ...
            case protocol.client.clearChunk:
                if (this.client.rank > 1) {
                    ...
                    if (currentChunkColor.every((value, index) => value === [r, g, b][index])) return;

                    var newData = new Uint8Array(16 * 16 * 3).fill(255);
